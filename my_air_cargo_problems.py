...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        # Concrete Action objects based on the domain action schema are created for: Load, Unload, and Fly.
        ...
        def unload_actions():
            """Creates all concrete Unload actions and return a list
        ...
        def fly_actions():
            """Creates all concrete Fly actions and return a list
    ...
    def goal_test(self, state: str) -> bool:
        """ Tests the state to see if goal is reached
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        executed.
        """
        # For explanation read: Russell-Norvig Ed-3 10.2.3  or Russell-Norvig Ed-2 11.2
        count = 0
